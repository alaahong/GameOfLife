...
public class PlayGameTest {
	...
	/*
	 * * @author : Wang Huiyuan : 1492174** @description : Any live cell with
	 * two live neighbours lives* on to the next generation* p3 stands for a
	 * live cell with two live neighbours* p7 stands for a dead cell with two
	 * live neighbours* Both of them are defined and initialized at the
	 * beginning of PlayGameTest definition
	 */
	@Test
	public void testValidateEqualsTwoLives() {
		...
		org.junit.Assert
				.assertFalse(
						"Dead cell with two live neighbours should be dead in next generation",
						1 == pg.validateEqualsTwoLives(p7, strArr));
	}

	/**
	 * @author WuYan(1492154)
	 * @description test the function of one dead with three lives.
	 */
	@Test
	public void testValidateEqualsThreeDead() {
		String[][] firstGenerationArray = new String[][] {
				{ ".", ".", ".", ".", ".", ".", ".", "." },
				{ ".", ".", ".", "*", "*", "*", ".", "." },
				{ ".", ".", ".", "*", ".", "*", ".", "." },
				{ ".", ".", ".", ".", ".", ".", ".", "." } };
		Point p = new Point(1, 4, 1);
		org.junit.Assert.assertEquals(0,
				pg.validateEqualsThreeDead(p, firstGenerationArray));
	}
	...
	public void nextStatusTest() {
		...
		for (int i = 1; i <= 5; i++) {
			...
			if (i == 1 || i == 4) {
				...
				System.out.println("Point (1, " + i + ") changes to "
						+ pg.nextStatus(p, initialArray));
	 ...
	 * @author: Hao Li
	 * 
	 * @description: given an alive cell surrounded by three alive cells, it
	 * should still live
	 */
	@Test
	public void testValidateEqualsThreeLive() {
		...
		org.junit.Assert.assertEquals(1,
				pg.validateEqualsThreeLive(p, initialArray));
	}
